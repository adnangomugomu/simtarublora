  ...
  <div class="content-wrapper" style="background-image:url(<?php echo $background ; ?>)">
    ...
    <section class="content">
				...
				<div class="row">
					<div class="col-md-12">
					<center>
					<h1 class="ml2" style="color:#FFFFFF;">PERMOHONAN INFORMASI TATA RUANG ONLINE</h1>
					<h2 style="color:#FFFFFF;">LAYANAN TATA RUANG KABUPATEN PEMALANG</h2>
					</center>
					<p>&nbsp;
						...
						<div class="box box-primary">
							...
							<div class="card px-0 pt-4 pb-0 mt-3 mb-3">
										...
										<form id="msform">
											<!-- progressbar -->
											<ul id="progressbar">
												<li class="active" id="personal"><strong>DATA PEMOHON</strong></li>
											...
											<fieldset>
												...
												<div class="alert alert-info border-0 alert-dismissible">
													...
													<div class="form-group row">
														<label class="col-form-label col-lg-4">Fotokopi SIUP / TDP (Bagi perusahaan)</label>
														<div class="col-lg-8">
											...
											<fieldset>
												<div class="form-card" align="center">
													...
													<a href="simtaru-permohonan_online_pemalang"><button type="button" class="next action-button" data-toggle="tooltip" data-placement="top" title="Kembali Ke Permohonan" style="width:250px;background-color:#65b145;border:#344772;"><i class="fa fa-credit-card"></i> Kembali Ke Permohonan</button></a>
													</center>
