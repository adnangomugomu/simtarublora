<?php 
	  ...
	  $sql="select * from si_permohonan where id='".$kodeid."'";
						...
						<div class="box box-success">
							...
							<div class="card px-0 pt-4 pb-0 mt-3 mb-3">
										...
										<form id="msform">
											...
											<fieldset>
											    <div class="form-card">
												<iframe id="simtaru" src="simtaru-p3t4_p3rm0h0n4n?prt=<?php echo encrypt($peruntukkanpermohonantataruang); ?>&kd=<?php echo $kodeid; ?>" style="width:100%;height:80vh;" frameborder="0" scrolling="no"></iframe>
												<input type="hidden" name="isilongitude" class="rounded" id="isilongitude" value="<?php echo $longitudesurvei ?>" readonly="yes" required>
												<input type="hidden" name="isilatitude" class="rounded" id="isilatitude" value="<?php echo $latitudesurvei ?>" readonly="yes" required>
												<input type="hidden" name="isiperuntukkan" class="rounded" id="isiperuntukkan" value="<?php echo $peruntukkanpermohonantataruang ?>" readonly="yes" required>
												</div>
...
if (confirm("Apakah data sudah benar dan lanjut simpan data?")) {
	...
	$.ajax({
		type: "POST",
		url: "landing/getupdatedatapermohonan.php",
		data: {
			nomorktp: nomorktp,
			nomortelp: nomortelp,
			nama: nama,
