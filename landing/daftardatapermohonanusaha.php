  ...
  <div class="content-wrapper" style="background-image:url(<?php echo $background ; ?>)">
    ...
    <section class="content">
				...
				<div class="row">
					<div class="col-md-12">
					<center>
					<h1 class="ml2" style="color:#000000;">DAFTAR PERMOHONAN KKPR BERUSAHA</h1>
					</center>
					<p>&nbsp;
					...
					<div class="col-md-10 col-md-offset-1">	
						<div class="box box-success">
								<div class="box-header with-border" style="background-color:#00a65a;color:#ffffff;">
								  <div class="col-md-12">
								  <h3 class="box-title" id="namaurusan">DATA PERMOHONAN <small style="color:#ffffff;">KKPR BERUSAHA</small></h3>
								  </div>
								  <div class="col-md-12">	
						...
						<?php
						$sql="select a.* from si_permohonan_usaha a 
						where a.deleted='0' 
						";
						...
						<tr>
							...
							<button class="btn btn-sm btn-primary btn-block" data-toggle="tooltip" data-placement="top" title="Cetak Hasil Permohonan" style="width:150px;background-color:#FF9900;border:#FF9900;" onClick="cetakhasil('<?php echo $kodeid; ?>')"><i class="fa fa-print"></i> Cetak Hasil</button>
							<form id="hapus<?php echo $i; ?>" action="simtaru-02hapususaha" method="post" enctype="multipart/form-data">
				...
				<div class="row" style="opacity:0.85;">
					<div class="col-md-10 col-md-offset-1">	
						...
						<tr>
							...
							{
							?>
							<button type="button" class="btn btn-sm btn btn-primary" data-toggle="tooltip" data-placement="top" title="Unduh Fotokopi NIB" style="width:150px;background-color:#92d22b;border:#92d22b;" onClick="DownloadFile('<?php echo $fc_nib; ?>')"><i class="fa fa-download"></i> Unduh Data</button>
							<?php
							}
							else
							{
								echo 'Tidak Ada Data Fotokopi NIB';
							}
							?>
							</td>
						</tr>
						<tr>
							<td data-title="Fotokopi Akta SK Kemenkumham">
							Fotokopi Akta SK Kemenkumham
							</td>
							<td data-title="Fotokopi Akta SK Kemenkumham">
							<?php
							...
							{
							?>
							<button type="button" class="btn btn-sm btn btn-primary" data-toggle="tooltip" data-placement="top" title="Unduh Fotokopi Akta SK Kemenkumham" style="width:150px;background-color:#92d22b;border:#92d22b;" onClick="DownloadFile('<?php echo $fc_aktausahakunham; ?>')"><i class="fa fa-download"></i> Unduh Data</button>
							<?php
							}
							else
							{
								echo 'Tidak Ada Data Fotokopi Akta SK Kemenkumham';
							}
							?>
							</td>
						</tr>
				...
				{
				?>
				<form name="form" action="simtaru-212" method="post" enctype="multipart/form-data">
				<div class="row" style="opacity:0.85;">
					<div class="col-md-10 col-md-offset-1">	
						<div class="box box-primary">
								<div class="box-header with-border" style="background-color:#00a65a;color:#ffffff;">
						...
						<tr>
							<td data-title="NIB" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							NIB
							</td>	
							<td data-title="NIB" colspan="3">
						...
						<tr>
							<td data-title="Nama Kegiatan Usaha" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Nama Kegiatan Usaha
							</td>	
							<td data-title="Nama Kegiatan Usaha" colspan="3">
						...
						<tr>
							<td data-title="Kode Rencana Fungsi Kegiatan Pemanfataan Ruang (KBLI)" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Kode Rencana Fungsi<br>Kegiatan Pemanfataan Ruang (KBLI)
							</td>	
							<td data-title="Kode Rencana Fungsi Kegiatan Pemanfataan Ruang (KBLI)" colspan="3">
						...
						<tr>
							<td data-title="Nama Rencana Fungsi Kegiatan Pemanfataan Ruang (KBLI)" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Nama Rencana Fungsi<br>Kegiatan Pemanfataan Ruang (KBLI)
							</td>	
							<td data-title="Nama Rencana Fungsi Kegiatan Pemanfataan Ruang (KBLI)" colspan="3">
						...
						<tr>
							<td data-title="Status Penanaman Modal" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Status Penanaman Modal
							</td>	
							<td data-title="Status Penanaman Modal" colspan="3">
						...
						<tr>
							<td data-title="Penggunaan Tanah Sekarang" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Penggunaan Tanah Sekarang
							</td>	
							<td data-title="Penggunaan Tanah Sekarang" colspan="3">
						...
						<tr>
							<td data-title="Luas Tanah Sesuai Bukti Kepemilikan Tanah" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Luas Tanah Sesuai Bukti Kepemilikan Tanah (m<sup>2</sup>)
							</td>	
							<td data-title="Luas Tanah Sesuai Bukti Kepemilikan Tanah" colspan="3">
						...
						<tr>
							<td data-title="Luas Tanah Sesuai Untuk Bangunan" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Luas Tanah Sesuai Untuk Bangunan (m<sup>2</sup>)
							</td>	
							<td data-title="Luas Tanah Sesuai Untuk Bangunan" colspan="3">
						...
						<tr>
							<td data-title="Rencana Tinggi Bangunan (m)" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Rencana Tinggi Bangunan (m)
							</td>	
							<td data-title="Rencana Tinggi Bangunan (m)" colspan="3">
						...
						<tr>
							<td data-title="Rencana Luas Lantai Bangunan" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Rencana Luas Lantai Bangunan (m<sup>2</sup>)
							</td>	
							<td data-title="Rencana Luas Lantai Bangunan" colspan="3">
						...
						<tr>
							<td data-title="Luas Tanah Yang Disetujui" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Luas Tanah Yang Disetujui (m<sup>2</sup>)
							</td>	
							<td data-title="Luas Tanah Yang Disetujui" colspan="3">
						...
						<tr>
							<td data-title="Jenis Peruntukkan Pemanfaatan Ruang" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Jenis Peruntukkan Pemanfaatan Ruang
							</td>	
							<td data-title="Jenis Peruntukkan Pemanfaatan Ruang" colspan="3">
						...
						<tr>
							<td data-title="Kode Klasifikasi Baku Lapangan Usaha Indonesia (KBLI)" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Kode Klasifikasi Baku Lapangan Usaha Indonesia (KBLI)
							</td>	
							<td data-title="Kode Klasifikasi Baku Lapangan Usaha Indonesia (KBLI)" colspan="3">
						...
						<tr>
							<td data-title="Judul Klasifikasi Baku Lapangan Usaha Indonesia (KBLI)" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Judul Klasifikasi Baku Lapangan Usaha Indonesia (KBLI)
							</td>	
							<td data-title="Judul Klasifikasi Baku Lapangan Usaha Indonesia (KBLI)" colspan="3">
						...
						<tr>
							<td data-title="KLB Maksimum" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							KLB Maksimum
							</td>	
							<td data-title="KBD Maksimum" colspan="3">
							<input type="text" name="klbmaks" class="rounded" id="klbmaks" placeholder="KLB Maksimum" value="<?php echo $klbmaks; ?>" data-toggle="tooltip" data-placement="top" title="Masukkan KLB Maksimum" onKeyPress="return isNumberKey(event)" required>
							</td>	
						</tr>
						<tr>
							<td data-title="Indikasi Program Pemanfaatan Ruang" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Indikasi Program Pemanfaatan Ruang
							</td>	
							<td data-title="Indikasi Program Pemanfaatan Ruang" colspan="3">
				...
				{
				?>
				<form name="form" action="simtaru-034savekkprpermohonan" method="post" enctype="multipart/form-data">
				<div class="row" style="opacity:0.85;">
					<div class="col-md-10 col-md-offset-1">	
						<div class="box box-primary">
								<div class="box-header with-border" style="background-color:#00a65a;color:#ffffff;">
								  <h3 class="box-title" id="namaurusan">HASIL PERMOHONAN <small style="color:#ffffff;">KKPR BERUSAHA</small></h3>
								</div>
						<div id="no-more-tables" class="box-body table-responsive no-padding">		
						<table class="table table-bordered table-hover">
						<thead class="cf">
...
<script type="text/javascript">
	function tambah()
	{
		window.location='simtaru-admin_kpprusaha';
	}
	function batal()
	{
		window.location='simtaru-t4b3lkkpr';
	}
</script>
...
{
window.open("simtaru-Print_kppr_usaha?str="+str);
}
</script>
...
{
		window.open('simtaru-cetakpdfusaha?kode='+kode);
}
</script>
</body>
</html>
