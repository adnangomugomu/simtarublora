  ...
  <div class="content-wrapper" style="background-image:url(<?php echo $background ; ?>)">
    ...
    <section class="content">
				...
				<div class="row">
					<div class="col-md-12">
					<center>
					<h1 class="ml2" style="color:#FFFFFF;">DAFTAR HASIL PERMOHONAN KKPR BERUSAHA</h1>
					</center>
					<p>&nbsp;
					...
					<div class="col-md-10 col-md-offset-1">	
						<div class="box box-primary">
								<div class="box-header with-border" style="background-color:#344772;color:#ffffff;">
								  <h3 class="box-title" id="namaurusan">DATA HASIL PERMOHONAN <small style="color:#ffffff;">KKPR BERUSAHA</small></h3>
								</div>
						
						<div id="no-more-tables" class="box-body table-responsive no-padding">
						<table class="table table-striped table-bordered table-hover">
						<thead class="cf">
						<tr style="background-color:#344772;color:#FFFFFF;">
						<th>No</th>
						<th>Tanggal</th>
						<th>Registrasi</th>
						<th>Pemohon</th>
						...
						<?php
						$sql="select a.*,b.nama as hasilpermohonan from si_permohonan_usaha a
						left join si_m_hasil b
						on a.hasil=b.id 
						where a.deleted='0' and a.createby='".$_SESSION['oneid']."'
						";
						...
						<tr>
							...
							<?php 
							$formattanggal= tgl_indo($row['createddate']);
							echo $formattanggal;
							?>
							</td>
							...
							<td data-title="Opsi">
							<button class="btn btn-sm btn-primary btn-block" data-toggle="tooltip" data-placement="top" title="Edit Data" style="width:150px;background-color:#92d22b;border:#92d22b;" onClick="editpermohonan('<?php echo encrypt($row['id']); ?>')"><i class="fa fa-pencil"></i> Edit</button>
							<button class="btn btn-sm btn-primary btn-block" data-toggle="tooltip" data-placement="top" title="Cetak Hasil Permohonan" onClick="cetakpeta('<?php echo encrypt($row['id']); ?>')" style="width:150px;background-color:#39dee4;border:#39dee4;"><i class="fa fa-print"></i> Cetak</button>
...
function editpermohonan(kodeid)
{
	window.location='simtaru-edit_pemohonan_usaha?simtaru='+kodeid;
}
</script>
