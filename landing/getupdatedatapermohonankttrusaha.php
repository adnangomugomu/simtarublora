...
$sql ="update si_permohonan_usaha set peruntukkanpermohonantataruang='".$_POST['isiperuntukkan']."' ";

$sql =$sql." , nib='".$_POST['nib']."' ";
$sql =$sql." , namakegiatanusaha='".$_POST['namakegiatanusaha']."' ";
$sql =$sql." , skalausaha='".$_POST['skalausaha']."' ";
$sql =$sql." , statusmodal='".$_POST['statusmodal']."' ";
...
{
	$sql =$sql." , latitudesurvei='".$latitude."' , longitudesurvei='".$longitude."', ogc_geom=".$fixkoordinat." ";
}
if ($_POST['fc_ktp_tmp']<>'')
{
...
if ($_POST['fc_nib_tmp']<>'')
{
	$sql =$sql." ,fc_nib='".$_POST['fc_nib_tmp']."'";
}
if ($_POST['fc_aktausahakunham_tmp']<>'')
{
	$sql =$sql." ,fc_aktausahakunham='".$_POST['fc_aktausahakunham_tmp']."'";
}

$sql =$sql." , updatedate=SYSDATE(), updateby='".$_SESSION['oneid']."' where id='".$_POST['kodeid']."'";
