					...
					<div class="col-md-10 col-md-offset-1">	
						<div class="box box-success">
								<div class="box-header with-border" style="background-color:#00a65a;color:#ffffff;">
								  <h3 class="box-title" id="namaurusan">DATA HASIL PERMOHONAN <small style="color:#ffffff;">INFORMASI TATA RUANG</small></h3>
								</div>
						...
						<?php
						$sql="select a.*,b.nama as hasilpermohonan from si_permohonan a
...
{
	window.location='simtaru-edit_pemohonan?simtaru='+kodeid;
}
</script>
