...
if (($_POST['action']=='edit') || ($tempkodeid) || ($tempkodeid<>''))
{
	...
	$setuju=$row['setuju'.$_COOKIE['onebidang']];
	$catatan=$row['cacatansetuju'.$_COOKIE['onebidang']];
...
<?php include 'headerfpr.php'; ?>
  ...
  <div class="content-wrapper" style="background-image:url(<?php echo $background ; ?>)">
    ...
    <section class="content">
				...
				{
				?>
				<form name="form" action="simtaru-999999" method="post" enctype="multipart/form-data">
				<div class="row" style="opacity:0.85;">
					<div class="col-md-10 col-md-offset-1">	
						<div class="box box-primary">
								<div class="box-header with-border" style="background-color:#00a65a;color:#ffffff;">
								  <i id="simbollihat" class="fa fa-plus-square fa-2x" style="cursor:pointer;display:none;float:left;" data-toggle="tooltip" data-placement="top" title="Perlihatkan Data Permohonan" onClick="perlihatkanpermohonan()"></i><i id="simbolsembunyi" class="fa fa-minus-square fa-2x" style="cursor:pointer;display:block;float:left;" data-toggle="tooltip" data-placement="top" title="Sembuyikan Data Permohonan" onClick="sembuyikanpermohonan()"></i> &nbsp;<h3 class="box-title" id="namaurusan">DATA PERMOHONAN <small style="color:#ffffff;">KKPR</small></h3>
								</div>
						</div>
					</div>
					<div class="col-md-10 col-md-offset-1" style="display:block;" id="detailpermohonan">	
						...
						<tr>
							...
							<?php echo $peruntukkanpermohonantataruang; ?>
							</td>	
						</tr>
						<tr>
							...
							<td data-title="Status Tanah" colspan="3">
								<?php
								$sqlmaster="select * from si_m_tanah where deleted='0' and id='".$statustanah."'";
						...
						<tr>
							...
							<?php echo $jenispemanfaatanruang; ?>
							</td>	
						</tr>
						<tr>
							...
							<?php echo $kawasanpemanfaatanruang; ?>
							</td>	
						</tr>
						<tr>
							...
							<td data-title="Letak Lokasi Kawasan" colspan="3"  data-toggle="tooltip" data-placement="top" title="Pilih Letak Lokasi Kawasan Peruntukkan Pemanfaatan Ruang" >
								<?php
								$sqlmaster="select * from si_m_letak where deleted='0' and id='".$letakkawasan."'";
								$resultmaster=mysqli_query($link,$sqlmaster);
								if ($resultmaster)
								{
								while ($rowmaster=mysqli_fetch_array($resultmaster))
						...
						<tr>
							...
							<?php echo $keterangankawasanpemanfaatanruang; ?>
							</td>
						</tr>
						<tr>
							<td data-title="Kode KBLI" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
						...
						<tr>
							...
							<td data-title="KTB Maksimum (%)" colspan="3">
							<?php echo $ktbmaks; ?>
							</td>	
						</tr>
						<tr>
						...
						<tr>
							...
							<td data-title="KWT Maksimum (%)" colspan="3">
							<?php echo $kwtmaks; ?>
							</td>	
						</tr>
						<tr>
						...
						<tr>
							...
							<td data-title="Hasil Pertimbangan" colspan="3"  data-toggle="tooltip" data-placement="top" title="Pilih Pertimbangan" >
								<?php
								$sqlmaster="select * from si_m_klasifikasi where deleted='0' and id='".$klasifikasi."'";
								$resultmaster=mysqli_query($link,$sqlmaster);
								if ($resultmaster)
								{
								while ($rowmaster=mysqli_fetch_array($resultmaster))
						...
						<tr>
							<td data-title="Koordinat Dimohon" style="background-color:#333333;color:#FFFFFF;border:#333333;" colspan="4">
							 Koordinat Dimohon
						...
						<tr>
							<td data-title="Latitude" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Latitude <?php echo $i+1; ?>
							</td>
							<td data-title="Latitude">
							<?php echo $templatitudesurvei[$i]; ?>
							</td>
							<td data-title="Longitude" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Longitude <?php echo $i+1; ?>
							</td>
							<td data-title="Longitude">
							<?php echo $templongitudesurvei[$i]; ?>
							</td>
						...
						<tr>
							<td data-title="Koordinat Disetujui" style="background-color:#333333;color:#FFFFFF;border:#333333;" colspan="4">
							 Koordinat Disetujui
						...
						<tr>
							...
							<td data-title="Latitude">
							<?php echo $templatitudesurveisetuju[0]; ?>
							</td>
							<td data-title="Longitude" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Longitude 1
							</td>
							<td data-title="Longitude">
							<?php echo $templongitudesurveisetuju[0]; ?>
							</td>
						...
						<tr>
							...
							<td data-title="Latitude">
							<?php echo $templatitudesurveisetuju[$i]; ?>
							</td>
							<td data-title="Longitude" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Longitude <?php echo $i+1; ?>
							</td>
							<td data-title="Longitude">
							<?php echo $templongitudesurveisetuju[$i]; ?>
							</td>
						...
						<tr>
							<td data-title="Foto Survei" style="background-color:#333333;color:#FFFFFF;border:#333333;" colspan="4">
							 Foto Survei
				...
				<div class="row" style="opacity:0.85;">
					<div class="col-md-10 col-md-offset-1">	
						<div class="box box-primary">
								<div class="box-header with-border" style="background-color:#00a65a;color:#ffffff;">
								  <h3 class="box-title" id="namaurusan">DATA PERSETUJUAN <small style="color:#ffffff;">FPR</small></h3>
								</div>
						</div>
						<div id="no-more-tables" class="box-body table-responsive no-padding">		
						<table class="table table-bordered table-hover">
						...
						<tr>
							<td data-title="Data Personil" style="background-color:#333333;color:#FFFFFF;border:#333333;" colspan="2">
							Data Tim FPR<input type="hidden" name="personilfpr" class="rounded" id="longitudesurvei" placeholder="Longitude" value="<?php echo $_COOKIE['onebidang']; ?>" data-toggle="tooltip" data-placement="top" title="Masukkan Longitude" onKeyPress="return isNumberKey(event)" required>
							</td>
						</tr>
						<tr>
							<td data-title="Nama Personil" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Nama Personil
							</td>
							<td data-title="Nama Personil" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
						...
						<tr>
							<td data-title="Jabatan Personil" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Jabatan Personil
							</td>
							<td data-title="Jabatan Personil" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							<?php echo $_COOKIE['oneemail']; ?>
							</td>
						</tr>	
						<tr>
							<td data-title="Persetujuan" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Persetujuan
							</td>
							<td data-title="Persetujuan" data-toggle="tooltip" data-placement="top" title="Pilih Hasil Persetujuan">
							<select name="setuju" id="setuju" name="setuju"  class="form-control select2" required>
							<?php 
							$sql = "select * from si_m_setuju where deleted = '0' order by id asc";
							$result = mysqli_query ($link,$sql);
							if ($result) {
								while ($row = mysqli_fetch_array ($result)) {
									$idsifat=$row['id'];
									$namasifat=$row['nama'];
									?>
							<option value="<?php echo $idsifat; ?>" <?php if ($idsifat==$setuju) { ?> selected="selected" <?php } ?> ><?php echo $namasifat; ?></option>
						...
						<tr>
						    <td data-title="Catatan" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Catatan
							</td>
							<td data-title="Catatan">
							<textarea class="rounded" rows="4" name="catatan" id="catatan" data-toggle="tooltip" data-placement="top" title="Masukkan Catatan Hasil Persetujuan" ><?php echo $catatan; ?></textarea>
							</td>
						</tr>
						<tr>
							<td data-title="TTE" style="background-color:#66CC99;color:#FFFFFF;border:#66CC99;">
							Tanda Tangan Elektronik
							</td>
							<td data-title="TTE">
							<button class="btn btn-sm btn-primary btn-block" type="button" data-toggle="tooltip" data-placement="top" title="TTE Dokumen" onClick="TTE('<?php echo $kodeid; ?>','<?php echo 'si_permohonan_non'; ?>','<?php echo 'tte_'.$_COOKIE['onebidang']; ?>','<?php echo get_Isi_Field1('NIK','si_userfpr','hp',$_COOKIE['onebidang']); ?>','<?php echo get_Isi_Field1('Passphrase','si_userfpr','hp',$_COOKIE['onebidang']); ?>')" style="width:150px;background-color:#0033CC;border:#0033CC;"><i class="fa fa-eye"></i> TTE Dokumen</button>
							</td>
						</tr>
						</table>
						</div>
...
<script type="text/javascript">
	...
	function batal()
	{
		window.location='simtaru-fprd4t4nnonkkpr';
	}
</script>
...
<script>
function cetakhasil(kode)
{
	window.open('simtaru-cetakpdf?kode='+kode);
}
function perlihatkanpermohonan()
{
	document.getElementById("simbolsembunyi").style.display = "block";
	document.getElementById("simbollihat").style.display = "none";
	document.getElementById("detailpermohonan").style.display = "block";
}
function sembuyikanpermohonan()
{
	document.getElementById("simbolsembunyi").style.display = "none";
	document.getElementById("simbollihat").style.display = "block";
	document.getElementById("detailpermohonan").style.display = "none";
}

sembuyikanpermohonan();
</script>
<script>
