...
<?php
	  ...
	  $sql="select * from si_permohonan_non where id='".$kodeid."'";
							...
							<div class="card px-0 pt-4 pb-0 mt-3 mb-3">
										...
										<form id="msform">
												...
												<div class="form-card">
													<div class="col-md-6">
														...
														<label for="nama">Nomor KTP </label>
														  <input type="text" name="nomorktp" class="rounded" id="nomorktp" placeholder="Nomor KTP" value="<?php echo $_COOKIE['onenip']; ?>" data-toggle="tooltip" data-placement="top" title="Masukkan Nomor KTP" readonly="yes" required>
														</div>
														<div class="form-group">
														...
														<label for="nama">Nama Pemohon  </label>
														  <input type="text" name="nama" class="rounded" id="nama" placeholder="Nama Pemohon " value="<?php echo $_COOKIE['onenama']; ?>" data-toggle="tooltip" data-placement="top" title="Masukkan Nama Pemohon" readonly="yes" required>
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
														<label for="nama">Nomor NPWP </label>
														  <input type="text" name="nomornpwp" class="rounded" id="nomornpwp" placeholder="Nomor NPWP" value="<?php echo $_COOKIE['onenpwp']; ?>" data-toggle="tooltip" data-placement="top" title="Masukkan Nomor NPWP" readonly="yes" required>
														</div>
														<div class="form-group">
														<label for="nama">Alamat Email</label>
														  <input type="text" name="email" class="rounded" id="email" placeholder="Alamat Email" value="<?php echo $_COOKIE['oneemail']; ?>" data-toggle="tooltip" data-placement="top" title="Masukkan Alamat Email Yang Aktif" readonly="yes" required>
														</div>
														<div class="form-group">
														<label for="nama">Pekerjaan Pemohon </label>
														  <input type="text" name="pekerjaan" class="rounded" id="pekerjaan" placeholder="Pekerjaan Pemohon" value="<?php echo $_COOKIE['onepekerjaan']; ?>" data-toggle="tooltip" data-placement="top" title="Masukkan Pekerjaan Pemohon" readonly="yes" required>
														</div>
													</div>
													<div class="col-md-12">
														<div class="form-group">
											...
											<fieldset>
											    <div class="form-card">
													<div class="col-md-12">
														...
														<label for="nama">Kegiatan</label>
														  <input type="text" name="kegiatan" class="rounded" id="kegiatan" placeholder="Kegiatan" value="<?php echo $kegiatan; ?>" data-toggle="tooltip" data-placement="top" title="Masukkan Kegiatan" required>
														</div>
														<div class="form-group">
														...
														<div class="form-group">
														<label for="nama">Kode Rencana Fungsi Kegiatan Pemanfataan Ruang (KBLI)</label>
														...
														<label for="nama">Nomor Sertifikat Tanah</label>
														  <input type="text" name="nomor_sertifikat" class="rounded" id="nomor_sertifikat" placeholder="Nomor Sertifikat Tanah" value="<?php echo $nomor_sertifikat; ?>" data-toggle="tooltip" data-placement="top" title="Masukkan Nomor Sertifikat Tanah" required>
														</div>
														<div class="form-group">
												...
												<iframe src="simtaru-peta_permohonan?prt=<?php echo encrypt($peruntukkanpermohonantataruang); ?>&kd=<?php echo $kodeid; ?>" id="simtaru" style="width:100%;height:100vh;" frameborder="0" scrolling="no"></iframe>
											...
											<fieldset>
												<div class="form-card" align="center">
													...
													<a href="simtaru-permohonan_kppr"><button type="button" class="next action-button" data-toggle="tooltip" data-placement="top" title="Kembali Ke Permohonan" style="width:250px;background-color:#65b145;border:#00a65a;"><i class="fa fa-credit-card"></i> Kembali Ke Permohonan</button></a>
													</center>
...
if (confirm("Apakah data sudah benar dan lanjut simpan data?")) {
	...
	$.ajax({
		type: "POST",
		url: "landing/getupdatedatapermohonankttrnon.php",
		data: {
			tipe: tipe,
			kegiatan: kegiatan,
