          ...
          <!-- Box Comment -->
            <div class="box-header with-border">
              <div class="user-block">
				...
				<div class="col-md-3">
			    <input class="rounded" id="peruntukkan" placeholder="Peruntukkan" readonly="yes" type="text" data-toggle="tooltip" data-placement="bottom" title="Klik Pada Peta Untuk Mengisi Peruntukkan lokasi" value="<?php echo $peruntukkanpermohonantataruang ?>">
				</div>
				
				<div class="box-footer box-comments">
              <p>
			  <h6 class="attachment-heading"><b><a href="#">Pengukuran</a></b></h6>
			  <input type="text" name="koordinatku" id="koordinatku" value="" style="width:100%;display:block;">	
			...
			<div class="box-body" id="map">
			  <div id="mouse-position" style="top:150px; right:50px; z-index:2;position:absolute;color:#FF0000;font-family:'Mangal',Verdana, Arial, Helvetica, sans-serif;"></div>
