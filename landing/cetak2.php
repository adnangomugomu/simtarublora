							...
							<div class="col-md-3"> 
							  <h6 class="attachment-heading"><b><a href="#">Keterangan</a></b></h6>
								  ...
								  if ($result)
								  {
									...
									<td valign="top" style="padding:1px;color:#000000;font-size:9px;" align="left">Lokasi Permohonan</td>
									</tr>
									<tr align="left">
									<td style="background-color:#ff1493;padding:1px;border:#1E90FF solid 2px;" width="24px;" align="left">&nbsp;&nbsp;</td>
									<td valign="top" style="padding:1px;color:#000000;font-size:9px;" align="left">Lokasi Kegiatan</td>
									</tr>
									<tr align="left">
									<td valign="top" colspan="2" align="left"><br>Luas Lokasi : <?php echo replace_dot_koma($luastanahsetuju); ?> m<sup>2</sup></td>
									</tr>
									<tr align="left">
									<td valign="top" colspan="2" align="left">Kegiatan : <?php echo $kegiatan; ?></td>
									</tr>
									<?php 
								  }
								  ?>
