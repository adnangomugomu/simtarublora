      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>
			  ...
			  <div class="radio">
				<label>
				  <input type="radio" name="optionsRadios" id="radio2" checked="checked" value="2">
				  MapQuest OSM
				</label>
			  </div> 
			  <div class="radio">
...
<!-- Modal -->
  <div class="modal fade" id="myModalLayer" role="modal" style="background: rgba(0, 0, 0, 0);" >
        ...
        <div class="modal-body">
		  ...
		  <div class="nav-tabs-custom" id="sampingkanan">
            <ul class="nav nav-tabs">
              ...
              <li style="display:none;"><a href="#settings" data-toggle="tab">Setting</a></li>
            </ul>
           ...
           <div class="active tab-pane" id="activity">
            ...
            <!-- /.box-body -->
              ...
              <!-- /.tab-pane -->
              <div class="tab-pane" id="layerlain" style="overflow:auto;max-height:75vh;">
			  <p>
				<?php
				...
				?>
				<p>
				<h5 style="color:#adbdf8;"><input type="checkbox" name="checkbox<?php echo $row1['id']; ?>" id="checkbox<?php echo $row1['id']; ?>"> <?php echo $row1['nama']; ?></h5>
				</p>
				<?php 
				$x++;
				}
    ...
    <section class="content">
	  <div class="row">
<div class="panel panel-primary" id="boxkugam" style="z-index:11;position:absolute;top:70px;left:17px;overflow:hidden;height:70px;border:solid 2px #FFFFFF;width:300px;border-bottom-right-radius:40px;background-color:#000000"><label style="position:absolute;left:60px;top:2px;color:#FFFFFF;font-size:26px;">PETA SPASIAL</label><label style="position:absolute;left:60px;top:35px;color:#FFFFFF;"><?php echo $judul; ?></label>
<img src="images/logo.png" height="40px;" style="position:absolute;top:8px;left:10px;">
</div>
        <div class="col-md-12">
          <!-- Box Comment -->
          <div class="box box-widget">
			...
			<div class="box-body" id="map">
			  <div id="mouse-position" style="bottom:10px; right:20px; z-index:2;position:absolute;color:#FF0000;font-family:'Mangal',Verdana, Arial, Helvetica, sans-serif;"></div>
		  	  <div id="divMainLayer"></div>
			  <button type="button" data-toggle="tooltip" data-placement="bottom" title="Halaman Utama" class="btn btn-success btn-circle btn-lg" style="z-index:40;position:absolute;right:290px;top:20px;border-radius:50%;height:50px;width:50px;" onClick="kembalikemenuutama()"><i class="glyphicon glyphicon-home"></i></button>
			  <button type="button" data-toggle="tooltip" data-placement="bottom" title="Layer" class="btn btn-success btn-circle btn-lg" style="z-index:40;position:absolute;right:235px;top:20px;border-radius:50%;height:50px;width:50px;" onClick="layerku()"><i class="glyphicon glyphicon-list-alt"></i></button>
			  <button type="button" data-toggle="tooltip" data-placement="bottom" title="Base Map" class="btn btn-success btn-circle btn-lg" style="z-index:40;position:absolute;right:180px;top:20px;border-radius:50%;height:50px;width:50px;" onClick="basemap()"><i class="glyphicon glyphicon-th-large"></i></button>
			  <button type="button" data-toggle="tooltip" data-placement="bottom" title="Zoom In" class="btn btn-success btn-circle btn-lg" style="z-index:40;position:absolute;right:125px;top:20px;border-radius:50%;height:50px;width:50px;" id="zoom1"><i class="glyphicon glyphicon-zoom-in"></i></button>
			  <button type="button" data-toggle="tooltip" data-placement="bottom" title="Zoom Out" class="btn btn-success btn-circle btn-lg" style="z-index:40;position:absolute;right:70px;top:20px;border-radius:50%;height:50px;width:50px;" id="zoom2"><i class="glyphicon glyphicon-zoom-out"></i></button>
			  <button type="button" data-toggle="tooltip" data-placement="bottom" title="Cetak Peta" class="btn btn-success btn-circle btn-lg" style="z-index:40;position:absolute;right:15px;top:20px;border-radius:50%;height:50px;width:50px;" id="export-png"><i class="glyphicon glyphicon-print"></i></button>
            </div>
			<div class="box-body" style="background-color:#6699FF;">
			<p>
			  <h6 class="attachment-heading"><b><a href="#">Pencarian Koordinat Lokasi</a></b></h6>
			  <input class="rounded" id="searchTextField" placeholder="Masukkan nama lokasi yang dicari" type="text">
			  <input class="rounded" id="city" type="text" size="47" style="font-family:Verdana;display:none;">
			  ...
			  <input class="rounded" id="location_id" type="text" size="47" style="font-family:Verdana;display:none;">
			  <br>
