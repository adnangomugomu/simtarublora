...
{
	$sql="select * from masukan where deleted='0' and id='".$kode."' ";
...
if ($action=='h')
{
$sql="update masukan set deleted='1' where id='".$kode."'";
//echo $sql;
//exit;
$result=mysqli_query($link,$sql);
?>
...
if ($_FILES['ikon']['name'])
        {
          ...
          $gambar = $newfilename;
		  $sql="insert into masukan (id,nama,ikon,deleted) values (null,'".$nama."','".$gambar."','0')";
        }
		else
		{
			$sql="insert into masukan (id,nama,deleted) values (null,'".$nama."','0')";
		}
...
if ($_FILES['ikon']['name'])
        {
          ...
          copy ($_FILES['ikon']['tmp_name'], $attachdir . $newfilename);
          $gambar = $newfilename;
		  $sql="update masukan set nama='".$nama."',ikon='".$gambar."' where id='".$kodeku."'";
        }
		else
		{
			$sql="update masukan set nama='".$nama."' where id='".$kodeku."'";
		}
	  ...
	  <div class="col-md-8 col-md-offset-2" style="opacity:0.85;">
	    <div class="box box-success">
			<div class="box-header with-border" style="background-color:#00a65a;color:#ffffff;">
			  <h3 class="box-title" id="namaurusan">Data <small style="color:#ffffff;">Aduan</small></h3>
	    	...
	    	<div class="box-body">
				<div id="no-more-tables" class="box-body table-responsive no-padding">
					...
					<th><div align="center">No Identitas</div></th>
					<th><div align="center">No Telp</div></th>
					<th><div align="center">Isi Aduan</div></th>
					</tr>
					</thead>
					<?php
					$sqlpengumuman="select * from masukan where deleted='0' order by tanggal desc";
					...
					$ikonpengumuman=$rowpengumuman['ktp'];
					$nomorhp=$rowpengumuman['nomorhp'];
					$isi=$rowpengumuman['isi'];
					$tanggal=$rowpengumuman['tanggal'];
					?>
					<tr>
					<td data-title="No">
					<?php echo $z; ?>
					...
					<td data-title="No Identitas">
					<?php
					echo $ikonpengumuman;
					?>
					</td>
					<td data-title="No Telp">
					<?php
					echo $nomorhp;
					?>
					</td>
					<td data-title="Isi Aduan">
					<?php
					echo $isi;
					?>
					</td>
