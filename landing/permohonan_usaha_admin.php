  ...
  <div class="content-wrapper" style="background-image:url(<?php echo $background ; ?>)">
    ...
    <section class="content">
				...
				<div class="row">
					<div class="col-md-12">
					<center>
					<h1 class="ml2" style="color:#000000;">TAMBAH PERMOHONAN KKPR BERUSAHA</h1>
					</center>
					<p>&nbsp;
										...
										<form id="msform">
											...
											<fieldset>
												<div class="form-card" align="center">
													...
													<a href="simtaru-admin_kpprusaha"><button type="button" class="next action-button" data-toggle="tooltip" data-placement="top" title="Kembali Ke Permohonan" style="width:250px;background-color:#65b145;border:#00a65a;"><i class="fa fa-credit-card"></i> Kembali Ke Permohonan</button></a>
													</center>
