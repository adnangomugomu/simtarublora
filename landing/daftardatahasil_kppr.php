					...
					<div class="col-md-10 col-md-offset-1">	
						<div class="box box-primary">
								<div class="box-header with-border" style="background-color:#00a65a;color:#ffffff;">
								  <h3 class="box-title" id="namaurusan">DATA HASIL <small style="color:#ffffff;">PERMOHONAN</small></h3>
								</div>
						...
						on a.hasil=b.id 
						where a.deleted='0' and a.createby='".$_COOKIE['oneid']."'
						";
...
{
	window.location='simtaru-edit_pemohonan_kppr?simtaru='+kodeid;
}
</script>
