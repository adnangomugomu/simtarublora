...
$para15 = strpos($parts, "simtaru-d4t4nnonkkpr");
	...
	<nav class="navbar navbar-static-top">
		<div class="container">
			<div class="navbar-header">
				...
				?>
					<a href="simtaru-dashboard" class="navbar-brand"><img src="<?php echo $gambar; ?>" height="30"></a>
				<?php
				}
				?>
			...
			<div class="collapse navbar-collapse pull-left" id="navbar-collapse">
				<ul class="nav navbar-nav">
					...
					if ($_COOKIE['onenama'] <> '') {
					?>
						<li class="<?php if ($para5) { ?> active <?php } ?>"><a href="simtaru-dashboard">DASHBOARD</a></li>
						<li class="dropdown<?php if (($para6) || ($para7) || ($para8) || ($para13) || ($para14) || ($para15) || ($para16)) { ?> active <?php } ?>">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">PERMOHONAN TATA RUANG <span class="caret"></span></a>
							<ul class="dropdown-menu" role="menu">
								<li><a href="simtaru-m0h0n_kppr_admin">1. Tambah Permohonan Kesesuaian Kegiatan Penataan Ruang (KKPR)</a></li>
						...
						<li>
							...
							<ul class="dropdown-menu" role="menu">
								<li><a href="#" onClick="showku('landing/m_map.php')">Daftar Peta</a></li>
								<li><a href="#" onClick="showkusetting('landing/m_settingmap.php')">Tematik Peta</a></li>
							</ul>
						</li>
						<li class="<?php if ($para12) { ?> active <?php } ?>"><a href="simtaru-f1leunduh">DOKUMEN</a></li>
						<li class="<?php if ($para18) { ?> active <?php } ?>"><a href="simtaru-us3rfpr">USER FPR</a></li>
