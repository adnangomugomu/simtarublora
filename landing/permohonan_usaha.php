					...
					<div class="col-md-10 col-md-offset-1">	
						<div class="box box-primary">
							<div class="box-header with-border" style="background-color:#344772;color:#ffffff;">
							  <h3 class="box-title" id="namaurusan">FORMULIR PERMOHONAN <small style="color:#ffffff;">KKPR BERUSAHA</small></h3>
							...
							<div class="card px-0 pt-4 pb-0 mt-3 mb-3">
										...
										<form id="msform">
											...
											<fieldset>
											    <div class="form-card">
													<div class="col-md-12">
														...
														<label for="nama">NIB</label>
														  <input type="text" name="nib" class="rounded" id="nib" placeholder="NIB" value="" data-toggle="tooltip" data-placement="top" title="Masukkan NIB" required>
														</div>
														<div class="form-group">
														<label for="nama">Nama Kegiatan Usaha</label>
														  <input type="text" name="namakegiatanusaha" class="rounded" id="namakegiatanusaha" placeholder="Nama Kegiatan Usaha" value="" data-toggle="tooltip" data-placement="top" title="Masukkan Nama Kegiatan Usaha" required>
														</div>
														<div class="form-group">
												...
												<iframe src="simtaru-peta_us4h4" id="simtaru" style="width:100%;height:100vh;" frameborder="0" scrolling="no"></iframe>
											...
											<fieldset>
												<div class="form-card" align="center">
													...
													<a href="simtaru-permohonan_usaha_kppr"><button type="button" class="next action-button" data-toggle="tooltip" data-placement="top" title="Kembali Ke Permohonan" style="width:250px;background-color:#65b145;border:#344772;"><i class="fa fa-credit-card"></i> Kembali Ke Permohonan</button></a>
													</center>
...
if (confirm("Apakah data sudah benar dan lanjut simpan data?")) {
	...
	$.ajax({
		type: "POST",
		url: "landing/getsimpandatapermohonankttrusaha.php",
		data: {
			nib: nib,
