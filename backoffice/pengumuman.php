...
{
	$sql="select * from one_pengumuman where deleted='0' and id='".$kode."' ";
...
if ($action=='h')
{
$sql="update one_pengumuman set deleted='1' where id='".$kode."'";
//echo $sql;
//exit;
$result=mysqli_query($link,$sql);
?>
<script>
window.location='pengumuman.php?suc=2';
</script>
<?php 
exit;
}
...
if ($_FILES['ikon']['name'])
        {
          ...
          $gambar = $newfilename;
		  $sql="insert into one_pengumuman (id,nama,isi,ikon,createdby,createdate,deleted) values (null,'".$nama."','".$isi."','".$gambar."','".$_SESSION['oneid']."','".$tanggal."','0')";
        }
		else
		{
			$sql="insert into one_pengumuman (id,nama,isi,deleted) values (null,'".$nama."','".$isi."','0')";
		}
...
?>
<script>
window.location='pengumuman.php?suc=1';
</script>
<?php 
exit;
}
...
if ($_FILES['ikon']['name'])
        {
          ...
          copy ($_FILES['ikon']['tmp_name'], $attachdir . $newfilename);
          $gambar = $newfilename;
		  $sql="update one_pengumuman set nama='".$nama."',isi='".$isi."',ikon='".$gambar."' ,createdby='".$_SESSION['oneid']."',createdate='".$tanggal."' where id='".$kodeku."'";
        }
		else
		{
			$sql="update one_pengumuman set nama='".$nama."',isi='".$isi."' where id='".$kodeku."'";
		}
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						...
						?>
							...
							<div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
										<?php
										$sql="select * from one_pengumuman where deleted='0' order by createdate DESC ";
										$result=mysqli_query($link,$sql);
										if ($result)
										{
										$i=1;
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $nama; ?></td>
											<td><?php echo $isi; ?></td>
                                            <td><img src="../img/<?php echo $ikon; ?>" height="30"></td>
                                            <td>
						...
						<div class="input-group">
							<div class="form-line">
								<textarea class="form-control" rows="5" id="isi" name="isi"  placeholder="Isi "></textarea>
							</div>
						</div>
						<h5>Gambar</h5>
						<div class="input-group">
							<div class="form-line">
								<input type="file" class="form-control" placeholder="Gambar" name="ikon" id="ikon" value="<?php echo $ikon; ?>" accept="image/*" required>
							</div>
						</div>
						...
						<div class="input-group">
							<div class="form-line">
								<textarea class="form-control" rows="5" id="isi" name="isi"  placeholder="Isi "><?php echo $isi; ?></textarea>
							</div>
						</div>
						<h5>Gambar</h5>
						<div class="input-group">
							<div class="form-line">
								<input type="file" class="form-control" placeholder="Gambar" name="ikon" id="ikon" value="<?php echo $ikon; ?>" accept="image/*">
							</div>
						<?php
						if ($ikon<>"")
						{
						?>
						 <img src="../img/<?php echo $ikon; ?>" height="30">
						<?php 
						}
						?>
						</div>
