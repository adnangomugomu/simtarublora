...
{
	$sql="select * from one_subbidang_peta where deleted='0' and id='".$kode."' ";
...
if ($action=='h')
{
$sql="update one_subbidang_peta set deleted='1' where id='".$kode."'";
//echo $sql;
//exit;
$result=mysqli_query($link,$sql);
?>
<script>
window.location='subb1dang.php?suc=2';
</script>
<?php 
exit;
}
...
$sql="insert into one_subbidang_peta (id,nama,bidang,deleted) values (null,'".$nama."','".$bidang."','0')";
...
?>
<script>
window.location='subb1dang.php?suc=1';
</script>
<?php 
exit;
}
...
$sql="update one_subbidang_peta set nama='".$nama."',bidang='".$bidang."' where id='".$kodeku."'";
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						...
						?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
										<?php
										$sql="select * from one_subbidang_peta where deleted='0' ";
										$result=mysqli_query($link,$sql);
										if ($result)
										{
										$i=1;
										...
										$kode=encrypt($row['id']);
										$nama=$row['nama'];
										$bidang=get_Isi_Field1('nama','one_bidang_peta','id',$row['bidang']);
						...
						<div class="input-group">
							<div class="form-line">
								<input type="text" name="nama" id="nama" class="form-control" placeholder="Nama Bidang Peta" required>
							</div>
						</div>
						<h5>Bidang Peta</h5>
						<select name="bidang" id="bidang" class="form-control show-tick">
							...
							?>
							<option value="<?php echo $kodeopsi; ?>" <?php if ($kodeopsi==$bidang) { ?> selected="selected" <?php } ?>><?php echo $namaopsi; ?></option>
							<?php
							}
							}
							?>
						...
						<div class="input-group">
							<div class="form-line">
								<input type="text" name="nama" id="nama" class="form-control" value="<?php echo $nama; ?>" placeholder="Nama Bidang Peta" >
							</div>
						</div>
						<h5>Bidang Peta</h5>
						<select name="bidang" id="bidang" class="form-control show-tick">
