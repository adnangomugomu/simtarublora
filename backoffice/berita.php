...
{
	$sql="select * from one_berita where deleted='0' and id='".$kode."' ";
...
if ($action=='h')
{
$sql="update one_berita set deleted='1' where id='".$kode."'";
//echo $sql;
//exit;
$result=mysqli_query($link,$sql);
?>
<script>
window.location='berita.php?suc=2';
</script>
<?php 
exit;
}
...
if ($_FILES['ikon']['name'])
        {
          ...
          $gambar = $newfilename;
		  $sql="insert into one_berita (id,nama,isi,ikon,createdby,createdate,deleted) values (null,'".$nama."','".$isi."','".$gambar."','".$_SESSION['oneid']."','".$tanggal."','0')";
        }
		else
		{
			$sql="insert into one_berita (id,nama,isi,deleted) values (null,'".$nama."','".$isi."','0')";
		}
...
?>
<script>
window.location='berita.php?suc=1';
</script>
<?php 
exit;
}
...
if ($_FILES['ikon']['name'])
        {
          ...
          copy ($_FILES['ikon']['tmp_name'], $attachdir . $newfilename);
          $gambar = $newfilename;
		  $sql="update one_berita set nama='".$nama."',isi='".$isi."',ikon='".$gambar."' ,createdby='".$_SESSION['oneid']."',createdate='".$tanggal."' where id='".$kodeku."'";
        }
		else
		{
			$sql="update one_berita set nama='".$nama."',isi='".$isi."' where id='".$kodeku."'";
		}
						...
						?>
							...
							<div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
										<?php
										$sql="select * from one_berita where deleted='0' order by createdate DESC ";
										$result=mysqli_query($link,$sql);
										if ($result)
										{
										$i=1;
