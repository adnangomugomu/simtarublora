...
{
	$sql="select * from one_master_peruntukkan where deleted='0' and id='".$kode."' ";
...
if ($action=='h')
{
$sql="update one_master_peruntukkan set deleted='1' where id='".$kode."'";
//echo $sql;
//exit;
$result=mysqli_query($link,$sql);
?>
<script>
window.location='peruntukkan.php?suc=2';
</script>
<?php 
exit;
}
...
$sql="insert into one_master_peruntukkan (id,nama,deleted) values (null,'".$nama."','0')";
...
?>
<script>
window.location='peruntukkan.php?suc=1';
</script>
<?php 
exit;
}
...
$sql="update one_master_peruntukkan set nama='".$nama."' where id='".$kodeku."'";
...
<body class="theme-red">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Master Peruntukkan Lahan / Kegiatan
                            </h2>
						...
						?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
										<?php
										$sql="select * from one_master_peruntukkan where deleted='0' ";
										$result=mysqli_query($link,$sql);
										if ($result)
										{
										$i=1;
						...
						<div class="input-group">
							<div class="form-line">
								<input type="text" name="nama" id="nama" class="form-control" placeholder="Peruntukkan Lahan / Kegiatan" required>
							</div>
						</div>
						...
						<div class="input-group">
							<div class="form-line">
								<input type="text" name="nama" id="nama" class="form-control" value="<?php echo $nama; ?>" placeholder="Peruntukkan Lahan / Kegiatan" required>
							</div>
						</div>
	...
	function batal()
	{
		...
		if (confirm("Kembali ke Tabel?")) {
			//alert("Hapus");
			window.location='peruntukkan.php';
		}
	}
	</script>
	<script>
