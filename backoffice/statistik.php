                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
										...
										<tr>
											...
											<td>
											<?php
											$qq="select count(id) as jml from one_grafik where nama='".$tempisitabel[$x]."'";
											...
											if ($jumqq==0)
											{
												echo "Grafik Belum Disetting di Manajemen Grafik";
											}
											else
											{
												echo "<b>Grafik Sudah Ada</b>";
											}
											?>
											</td>
                                            <td>
											<button class="btn btn-warning waves-effect" type="button" onClick="showku('<?php echo $tempisitabel[$x]; ?>')">Manajemen Grafik</button>
...
function ubahhalaman(id)
{
	...
	iframe.src = "grafik.php?tabel="+xx;
}
</script>
