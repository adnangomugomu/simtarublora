...
{
	$sql="select * from one_aliasfield where deleted='0' and id='".$kode."' ";
...
if ($action=='h')
{
$sql="update one_aliasfield set deleted='1' where id='".$kode."'";
//echo $sql;
//exit;
$result=mysqli_query($link,$sql);
?>
<script>
window.location='aliasfield.php?suc=2';
</script>
<?php 
exit;
}
...
$nama=$_POST['nama'];
$aliasfield=$_POST['aliasfield'];

$sql="insert into one_aliasfield (id,nama,aliasfield,deleted) values (null,'".$nama."','".$aliasfield."','0')";
...
?>
<script>
window.location='aliasfield.php?suc=1';
</script>
<?php 
exit;
}
...
$sql="update one_aliasfield set nama='".$nama."',aliasfield='".$aliasfield."' where id='".$kodeku."'";
...
<body class="theme-red">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						...
						?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
										<?php
										$sql="select * from one_aliasfield where deleted='0' ";
										$result=mysqli_query($link,$sql);
										if ($result)
										{
										$i=1;
						...
						<div class="input-group">
							<div class="form-line">
								<input type="text" name="aliasfield" id="aliasfield" class="form-control" placeholder="Alias Field" required>
							</div>
						</div>
						...
						<div class="input-group">
							<div class="form-line">
								<input type="text" name="aliasfield" id="aliasfield" class="form-control" value="<?php echo $aliasfield; ?>" placeholder="Alias Field" required>
							</div>
						</div>
	...
	function batal()
	{
		...
		if (confirm("Kembali ke Tabel?")) {
			//alert("Hapus");
			window.location='aliasfield.php';
		}
	}
	</script>
	<script>
