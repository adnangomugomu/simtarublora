...
{
	$sql="select * from one_tautan where deleted='0' and id='".$kode."' ";
...
if ($action=='h')
{
$sql="update one_tautan set deleted='1' where id='".$kode."'";
//echo $sql;
//exit;
$result=mysqli_query($link,$sql);
?>
<script>
window.location='tautan.php?suc=2';
</script>
<?php 
exit;
}
...
if ($_FILES['ikon']['name'])
        {
          ...
          $gambar = $newfilename;
		  $sql="insert into one_tautan (id,nama,ikon,tautan,deleted) values (null,'".$nama."','".$gambar."','".$tautan."','0')";
        }
		else
		{
			$sql="insert into one_tautan (id,nama,tautan,deleted) values (null,'".$nama."','".$tautan."','0')";
		}
...
?>
<script>
window.location='tautan.php?suc=1';
</script>
<?php 
exit;
}
...
if ($_FILES['ikon']['name'])
        {
          ...
          copy ($_FILES['ikon']['tmp_name'], $attachdir . $newfilename);
          $gambar = $newfilename;
		  $sql="update one_tautan set nama='".$nama."',ikon='".$gambar."',tautan='".$tautan."' where id='".$kodeku."'";
        }
		else
		{
			$sql="update one_tautan set nama='".$nama."',tautan='".$tautan."' where id='".$kodeku."'";
		}
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						...
						?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
										<?php
										$sql="select * from one_tautan where deleted='0' ";
										$result=mysqli_query($link,$sql);
										if ($result)
										{
										$i=1;
						...
						<div class="input-group">
							<div class="form-line">
								<input type="text" name="tautan" id="tautan" class="form-control" value="<?php echo $tautan; ?>" placeholder="Tautan" required>
							</div>
						</div>
						<h5>Ikon</h5>
						<div class="input-group">
							<div class="form-line">
								<input type="file" class="form-control" placeholder="Ikon" name="ikon" id="ikon" value="<?php echo $ikon; ?>" accept="image/x-png">
							</div>
						</div>
