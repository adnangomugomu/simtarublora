...
{
	$sql="select * from one_regulasi where deleted='0' and id='".$kode."' ";
...
if ($action=='h')
{
$sql="update one_regulasi set deleted='1' where id='".$kode."'";
//echo $sql;
//exit;
$result=mysqli_query($link,$sql);
?>
<script>
window.location='regulasi.php?suc=2';
</script>
<?php 
exit;
}
...
if ($_FILES['ikon']['name'])
        {
          ...
          $gambar = $newfilename;
		  $sql="insert into one_regulasi (id,nama,ikon,status,deleted) values (null,'".$nama."','".$gambar."','".$status."','0')";
        }
		else
		{
			$sql="insert into one_regulasi (id,nama,status,deleted) values (null,'".$nama."','".$status."','0')";
		}
...
?>
<script>
window.location='regulasi.php?suc=1';
</script>
<?php 
exit;
}
...
if ($_FILES['ikon']['name'])
        {
          ...
          copy ($_FILES['ikon']['tmp_name'], $attachdir . $newfilename);
          $gambar = $newfilename;
		  $sql="update one_regulasi set nama='".$nama."',ikon='".$gambar."',status='".$status."' where id='".$kodeku."'";
        }
		else
		{
			$sql="update one_regulasi set nama='".$nama."',status='".$status."' where id='".$kodeku."'";
		}
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						...
						?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
										<?php
										$sql="select * from one_regulasi where deleted='0' ";
										$result=mysqli_query($link,$sql);
										if ($result)
										{
										$i=1;
                                        ...
                                        <tr>
                                            <td><?php echo $i; ?></td>
                                            <td><?php echo $nama; ?></td>
                                            <td><a href="../img/<?php echo $ikon; ?>" target="_blank"><?php echo $ikon; ?></a></td>
						...
						<div class="input-group">
							<div class="form-line">
								<input type="text" name="nama" id="nama" class="form-control" placeholder="Nama Regulasi" required>
							</div>
						</div>
						<h5>File Pdf</h5>
						<div class="input-group">
							<div class="form-line">
								<input type="file" class="form-control" placeholder="File Pdf" name="ikon" id="ikon" value="<?php echo $ikon; ?>" accept="application/pdf">
							</div>
						</div>
						<h5>Status</h5>
						<div class="input-group">
							<div class="form-line">
								<input type="text" name="status" id="status" class="form-control" value="<?php echo $status; ?>" placeholder="Status Regulasi" required>
							</div>
						</div>
						...
						<div class="input-group">
							<div class="form-line">
								<input type="text" name="nama" id="nama" class="form-control" value="<?php echo $nama; ?>" placeholder="Nama Regulasi" required>
							</div>
						</div>
						<h5>File Pdf</h5>
						<div class="input-group">
						...
						{
						?>
						 <a href="../img/<?php echo $ikon; ?>" target="_blank"><?php echo $ikon; ?></a>
						<?php 
						}
						?>
						</div>
						...
						<div class="input-group">
							<div class="form-line">
								<input type="text" name="status" id="status" class="form-control" value="<?php echo $statusku; ?>" placeholder="Status Regulasi" required>
							</div>
						</div>
