...
{
	$sql="select * from one_master_zonasi where deleted='0' and id='".$kode."' ";
...
if ($action=='h')
{
$sql="update one_master_zonasi set deleted='1' where id='".$kode."'";
//echo $sql;
//exit;
$result=mysqli_query($link,$sql);
?>
<script>
window.location='zonasi.php?suc=2';
</script>
<?php 
exit;
}
...
$sql="insert into one_master_zonasi (id,nama,deleted) values (null,'".$nama."','0')";
...
?>
<script>
window.location='zonasi.php?suc=1';
</script>
<?php 
exit;
}
...
$sql="update one_master_zonasi set nama='".$nama."' where id='".$kodeku."'";
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						...
						?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
										<?php
										$sql="select * from one_master_zonasi where deleted='0' ";
										$result=mysqli_query($link,$sql);
										if ($result)
										{
										$i=1;
						...
						<div class="input-group">
							<div class="form-line">
								<input type="text" name="nama" id="nama" class="form-control" placeholder="Nama Zonasi" required>
							</div>
						</div>
						...
						<div class="input-group">
							<div class="form-line">
								<input type="text" name="nama" id="nama" class="form-control" value="<?php echo $nama; ?>" placeholder="Nama Zonasi" required>
							</div>
						</div>
