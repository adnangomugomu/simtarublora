...
{
	$sql="select * from one_galeri where deleted='0' and id='".$kode."' ";
...
if ($action=='h')
{
$sql="update one_galeri set deleted='1' where id='".$kode."'";
//echo $sql;
//exit;
$result=mysqli_query($link,$sql);
?>
<script>
window.location='galeri.php?suc=2';
</script>
<?php 
exit;
}
...
if ($_FILES['ikon']['name'])
        {
          ...
          $gambar = $newfilename;
		  $sql="insert into one_galeri (id,nama,ikon,deleted) values (null,'".$nama."','".$gambar."','0')";
        }
		else
		{
			$sql="insert into one_galeri (id,nama,deleted) values (null,'".$nama."','0')";
		}
...
?>
<script>
window.location='galeri.php?suc=1';
</script>
<?php 
exit;
}
...
if ($_FILES['ikon']['name'])
        {
          ...
          copy ($_FILES['ikon']['tmp_name'], $attachdir . $newfilename);
          $gambar = $newfilename;
		  $sql="update one_galeri set nama='".$nama."',ikon='".$gambar."' where id='".$kodeku."'";
        }
		else
		{
			$sql="update one_galeri set nama='".$nama."' where id='".$kodeku."'";
		}
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						...
						?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
										<?php
										$sql="select * from one_galeri where deleted='0' ";
										$result=mysqli_query($link,$sql);
										if ($result)
										{
										$i=1;
						...
						<div class="input-group">
							<div class="form-line">
								<input type="text" name="nama" id="nama" class="form-control" placeholder="Nama Produk Hukum" required>
							</div>
						</div>
						<h5>File Pdf</h5>
						<div class="input-group">
						...
						<div class="input-group">
							<div class="form-line">
								<input type="text" name="nama" id="nama" class="form-control" value="<?php echo $nama; ?>" placeholder="Nama Produk Hukum" required>
							</div>
						</div>
						<h5>File Pdf</h5>
						<div class="input-group">
