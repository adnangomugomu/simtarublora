...
{
	$sql="select * from one_gambar where deleted='0' and id='".$kode."' ";
...
if ($action=='h')
{
$sql="update one_gambar set deleted='1' where id='".$kode."'";
//echo $sql;
//exit;
$result=mysqli_query($link,$sql);
?>
<script>
window.location='gambar.php?suc=2';
</script>
<?php 
exit;
}
...
if ($_FILES['ikon']['name'])
        {
          ...
          $gambar = $newfilename;
		  $sql="insert into one_gambar (id,nama,ikon,grup,deleted) values (null,'".$nama."','".$gambar."','".$grup."','0')";
        }
		else
		{
			$sql="insert into one_gambar (id,nama,grup,deleted) values (null,'".$nama."','".$grup."','0')";
		}
...
?>
<script>
window.location='gambar.php?suc=1';
</script>
<?php 
exit;
}
...
if ($_FILES['ikon']['name'])
        {
          ...
          copy ($_FILES['ikon']['tmp_name'], $attachdir . $newfilename);
          $gambar = $newfilename;
		  $sql="update one_gambar set nama='".$nama."',ikon='".$gambar."',grup='".$grup."' where id='".$kodeku."'";
        }
		else
		{
			$sql="update one_gambar set nama='".$nama."',grup='".$grup."' where id='".$kodeku."'";
		}
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						...
						?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
										<?php
										$sql="select * from one_gambar where deleted='0' ";
										$result=mysqli_query($link,$sql);
										if ($result)
										{
										$i=1;
						...
						<div class="input-group">
							<div class="form-line">
								<input type="text" name="grup" id="grup" class="form-control" placeholder="Nama Grup Album Galeri" required>
							</div>
						</div>
						<h5>Nama</h5>
						<div class="input-group">
							<div class="form-line">
								<input type="text" name="nama" id="nama" class="form-control" placeholder="Nama Album Galeri" required>
							</div>
						</div>
						<h5>Gambar</h5>
						<div class="input-group">
						...
						<div class="input-group">
							<div class="form-line">
								<input type="text" name="grup" id="grup" class="form-control" value="<?php echo $grup; ?>" placeholder="Nama Grup Album Galeri" required>
							</div>
						</div>
						<h5>Nama </h5>
						<div class="input-group">
							<div class="form-line">
								<input type="text" name="nama" id="nama" class="form-control" value="<?php echo $nama; ?>" placeholder="Nama Album Galeri" required>
							</div>
						</div>
						<h5>Gambar</h5>
						<div class="input-group">
