							...
							<div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
										...
										?>
                                        <tr>
                                            <td><?php echo " &nbsp;Layer ".$x." : ".$tempisitabel[$x]; ?></td>
                                            <td>
											
											<button class="btn btn-danger waves-effect" type="button" onClick="tabel('<?php echo $tempisitabel[$x]; ?>')">Lihat Data </button>
											<button class="btn btn-success waves-effect" type="button" onClick="shp('<?php echo $tempisitabel[$x]; ?>')">Unduh Data </button>
...
function kembali()
{
document.location="tabelstatistik.php";
}
</script>
